...
let EATHO_RED_DARK = #colorLiteral(red: 0.64, green: 0.3035573123, blue: 0.301027668, alpha: 1)
...
let EATHO_YELLOW_DARK = #colorLiteral(red: 0.64, green: 0.4626506024, blue: 0.287871486, alpha: 1)
